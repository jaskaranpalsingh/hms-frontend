        ...
        <div className="bg-primary-600 px-8 py-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
             ...
             <div className="space-y-0.5">
                <h2 className="text-lg font-black text-white uppercase tracking-tight">Physician Portal</h2>
                <p className="text-[10px] text-primary-100 font-bold uppercase tracking-[0.2em]">Secure Clinical Communication</p>
             </div>
          </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
             ...
             <div className="flex flex-col">
                <h3 className="text-sm font-black text-slate-800 uppercase tracking-tight">Dr. {doctor.name}</h3>
                <span className="text-[10px] font-bold text-primary-600 uppercase tracking-widest">{doctor.specialization}</span>
             </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
             <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-2 flex items-center gap-2">
                   ...
                   Clinical Message Protocol
                </label>
                <textarea 
                  required
                  value={message}
                  onChange={(e) => setMessage(e.target.value)}
                  placeholder="Compose your message regarding symptoms, follow-ups, or clinical inquiries..."
             ...
             <div className="flex items-center gap-3 p-4 bg-amber-50 text-amber-700 rounded-2xl border border-amber-100/50">
                ...
                <p className="text-[10px] font-bold leading-relaxed uppercase tracking-tight">
                   Note: This message will be recorded in your clinical file. In case of emergency, please visit the ER immediately.
                </p>
             </div>
